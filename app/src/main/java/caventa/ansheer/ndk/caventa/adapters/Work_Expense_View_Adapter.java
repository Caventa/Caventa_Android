 ...
 */
public class Work_Expense_View_Adapter extends RecyclerView.Adapter<Work_Expense_View_Adapter.ViewHolder> {
...
//            overflow = (ImageView) view.findViewById(R.id.overflow);
    ...
    public Work_Expense_View_Adapter(Context mContext, List<Work_Expense> work_expenses) {
        this.mContext = mContext;
        this.work_expenses = work_expenses;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public Work_Expense_View_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                   int viewType) {
        // create a new view
...
//        return vh;
        ...
        return new Work_Expense_View_Adapter.ViewHolder(itemView);
    }
...
//        holder.mTextView.setText(mDataset[position]);
        ...
        Work_Expense work_expense = work_expenses.get(position);
        holder.description_amount.setText(work_expense.getDescription() + " - " + work_expense.getAmount());
