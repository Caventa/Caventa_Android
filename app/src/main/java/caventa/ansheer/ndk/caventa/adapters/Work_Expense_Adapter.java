 ...
 */
public class Work_Expense_Adapter extends RecyclerView.Adapter<Work_Expense_Adapter.ViewHolder> {
...
//            overflow = (ImageView) view.findViewById(R.id.overflow);
    ...
    public Work_Expense_Adapter(Context mContext, List<Work_Expense> work_expenses) {
    ...
    @Override
    public Work_Expense_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                              int viewType) {
        // create a new view
...
//        return vh;
        ...
        return new Work_Expense_Adapter.ViewHolder(itemView);
    }
